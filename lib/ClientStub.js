...
var ClientStub = {
    ...
    getInitMessage: function (hostInfo, appname){
        ...
        let convertInt64setProcessId = new common.OptionalInt64();
        ...
        transactions.forEach(function(item){
            ...
            if(item.externals === []){
                ...
                externalData.forEach(function(ext){
                    ...
                    let service_call = new Aggregate_pb.Aggregate.ServiceCall();
                    service_call = {
                        text: ext.url,
                        total_duration_nanos: ext.time,
                        execution_count: execution_count_service
                    } 
                    let service_calls_by_type = new Aggregate_pb.Aggregate.ServiceCallsByType();
                    service_calls_by_type = {
                        type: ext.method,
            ...
            let errors = _.values(item.errors);
                ...
                if(errorObject.length > 0){
                    errorObject.forEach(function(err){
                        ...
                        let longVal = new Long(0xFFFFFFFF, 0x7FFFFFFF);
                        longVal = new Date(Date.now()).getTime();
                        let SharedQueryText = new collectorService.Aggregate.SharedQueryText();
                        SharedQueryText = {
                            full_text: 'hello world',
                            truncated_text: '',
                            full_text_sha1: ''
                        };
                        let TraceStreamMessageH = new collectorService.TraceStreamMessage();
                        let TraceStreamMessageSQT = new collectorService.TraceStreamMessage();
                        let TraceStreamMessageT = new collectorService.TraceStreamMessage();

                        let TraceStreamHeader = new collectorService.TraceStreamHeader();
                        TraceStreamHeader = { 
                            agent_id: hostInfo.host,
                            trace_id: uuidV1(),
                            update : false
                        ...
                        let TraceSharedQueryText = new  collectorService.Trace.SharedQueryText();
                        TraceSharedQueryText = {
                            full_text: 'Tansaction Shared',
                            truncated_text: '',
                            truncated_end_text: '',
                            full_text_sha1: '' };
                        TraceStreamMessageSQT = {
                          stream_header: null,
                        ...
                        let Header = new collectorService.Trace.Header();

                        let attribute = new collectorService.Trace.Attribute();
                        attribute = {
                            name: 'aa',
                            value: ['bb']
                        };
                        let DetailValue = new collectorService.Trace.DetailValue();
                        DetailValue = {
                            long: longVal
                        }

                        let detail_entry = new collectorService.Trace.DetailEntry();
                        detail_entry = {
                            name: 'aa',
                            value: [DetailValue],
                            child_entry: []
                        };
                        let error = new collectorService.Trace.Error();
                        error = {
                        ...
                        let main_thread_root_timerT = new collectorService.Trace.Timer();
                        main_thread_root_timerT = {
                            name: '',
                            extended: false,
                        ...
                        let QueryEntryMessage = new collectorService.Trace.QueryEntryMessage();
                        QueryEntryMessage =
                            {
                        ...
                        let entry = new collectorService.Trace.Entry();
                        entry = {
                            depth: 0,
                        ...
                        //     shared_query_text: [SharedQueryText]
                        // };
                        let error_new = new collectorService.Trace.Error();
                        error_new = {
                            message: err.message,
                            exception: null
                        };
                        let entry_new = new collectorService.Trace.Entry();
                        entry_new = {
                            depth: 0,
                            start_offset_nanos: longVal,
                            duration_nanos: longVal,
